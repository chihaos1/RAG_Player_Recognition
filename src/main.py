...
from utils.openai import initialize_openai
...
@log
async def query_images(index_name: str, openai_api_key: str, pinecone_api_key: str):
...
if __name__ == "__main__":
    ...
    run(query_images(INDEX_NAME,OPENAI_API_KEY,PINECONE_API_KEY))
